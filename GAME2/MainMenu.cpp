...
void MainMenu_Load() {
	...
	AEGfxTriAdd(
		-0.5f, -0.5f, 0x00FF0FF, 0.0f, 0.0f,
		0.5f, -0.5f, 0x00FFFFFF, 1.0f, 0.0f,
		-0.5, 0.5f, 0x0000FFFF, 0.0f, 1.0f);
...
void MainMenu_Draw() {
	...
	//AEMtx33Trans(&translate, cursor_x -395.f, -cursor_y +290.f);
	AEMtx33Trans(&translate, 0.f - 180.f *2.0f, -180.f);
	transform = { 0 };
	AEMtx33Concat(&transform, &translate, &scale);
	AEGfxSetTransform(transform.m);
	// Drawing the mesh (list of triangles)
